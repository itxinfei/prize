...
-- ----------------------------
INSERT INTO `card_game` VALUES (4, '红包雨-随机', NULL, '测试红包雨', '2019-09-09 10:11:35', '2021-09-09 17:30:16', 2, 0);
INSERT INTO `card_game` VALUES (5, '红包雨-幸运转盘', NULL, '红包雨-幸运转盘', '2019-09-09 10:11:35', '2021-09-09 10:11:35', 1, 0);
...
INSERT INTO `card_game_product` VALUES (18, 5, 1, 10);
INSERT INTO `card_game_product` VALUES (19, 5, 2, 10);
INSERT INTO `card_game_product` VALUES (20, 5, 4, 10);
INSERT INTO `card_game_product` VALUES (21, 4, 1, 100);
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '活动策略' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of card_game_rules
-- ----------------------------
INSERT INTO `card_game_rules` VALUES (7, 4, 1, 2, 0);
INSERT INTO `card_game_rules` VALUES (8, 4, 2, 0, 0);
INSERT INTO `card_game_rules` VALUES (17, 4, 3, 0, 0);
INSERT INTO `card_game_rules` VALUES (18, 4, 4, 0, 0);
INSERT INTO `card_game_rules` VALUES (19, 4, 0, 0, 0);
INSERT INTO `card_game_rules` VALUES (20, 5, 0, 0, 0);
INSERT INTO `card_game_rules` VALUES (21, 5, 1, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of card_user
-- ----------------------------
INSERT INTO `card_user` VALUES (7, 'a', '/upload/images/timg (2)3.jpg', 'cc175b9c0f1b6a831c399e269772661', 'a', 'a', 'a', 0, '2020-12-09 17:37:28', '2020-12-09 17:37:28');

-- ----------------------------
-- Table structure for card_user_game
-- ----------------------------
...
CREATE TABLE `common_file`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件管理' ROW_FORMAT = Compact;
...
INSERT INTO `common_file` VALUES (25, 1, 'timg (2)2.jpg', 2, '2020-12-09 15:55:45');
INSERT INTO `common_file` VALUES (26, 1, 'java红1.jpg', 2, '2020-12-09 15:56:57');
INSERT INTO `common_file` VALUES (27, 1, 'timg (2)3.jpg', 2, '2020-12-09 17:37:23');
...
CREATE TABLE `sys_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 247 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登陆日志' ROW_FORMAT = Compact;
...
INSERT INTO `sys_login_log` VALUES (246, 'zcurd', '8F0FB3942FE8603DB2601EA7FAE3DA3C', '0:0:0:0:0:0:0:1', 1, '登陆成功', '2020-12-09 17:37:02');
...
CREATE TABLE `sys_oplog`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 745 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_oplog` VALUES (727, 2, '[会员信息] 删除', '0:0:0:0:0:0:0:1', '2020-12-09 15:55:31');
INSERT INTO `sys_oplog` VALUES (728, 2, '[会员admin] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 15:56:01');
INSERT INTO `sys_oplog` VALUES (729, 2, '[会员pangzhao] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 15:57:06');
INSERT INTO `sys_oplog` VALUES (730, 2, '[活动管理] 删除', '0:0:0:0:0:0:0:1', '2020-12-09 15:59:33');
INSERT INTO `sys_oplog` VALUES (731, 2, '[活动管理] 修改', '0:0:0:0:0:0:0:1', '2020-12-09 16:00:03');
INSERT INTO `sys_oplog` VALUES (732, 2, '[活动管理] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 16:01:48');
INSERT INTO `sys_oplog` VALUES (733, 2, '[配置奖品] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 16:02:04');
INSERT INTO `sys_oplog` VALUES (734, 2, '[配置奖品] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 16:02:12');
INSERT INTO `sys_oplog` VALUES (735, 2, '[配置奖品] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 16:02:18');
INSERT INTO `sys_oplog` VALUES (736, 2, '[配置奖品] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 16:02:35');
INSERT INTO `sys_oplog` VALUES (737, 2, '登陆系统', '0:0:0:0:0:0:0:1', '2020-12-09 17:37:02');
INSERT INTO `sys_oplog` VALUES (738, 2, '[会员a] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 17:37:29');
INSERT INTO `sys_oplog` VALUES (739, 2, '[活动策略] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 17:39:57');
INSERT INTO `sys_oplog` VALUES (740, 2, '[活动策略] 修改', '0:0:0:0:0:0:0:1', '2020-12-09 17:40:30');
INSERT INTO `sys_oplog` VALUES (741, 2, '[活动策略] 修改', '0:0:0:0:0:0:0:1', '2020-12-09 17:40:36');
INSERT INTO `sys_oplog` VALUES (742, 2, '[活动策略] 修改', '0:0:0:0:0:0:0:1', '2020-12-09 17:40:41');
INSERT INTO `sys_oplog` VALUES (743, 2, '[活动策略] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 17:41:08');
INSERT INTO `sys_oplog` VALUES (744, 2, '[活动策略] 增加', '0:0:0:0:0:0:0:1', '2020-12-09 17:41:13');
